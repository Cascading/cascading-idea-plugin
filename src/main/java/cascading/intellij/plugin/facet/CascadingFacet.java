...
import cascading.intellij.plugin.search.CascadingSearchScope;
...
public class CascadingFacet extends Facet<CascadingFacetConfiguration>
  {
  private List<VirtualFilePointer> resourcePaths;

  public CascadingFacet( @NotNull FacetType facetType, @NotNull Module module, String name, @NotNull CascadingFacetConfiguration configuration, Facet underlyingFacet )
    {
  ...
  public void setResourcePaths( @NotNull List<VirtualFilePointer> resourcePaths )
    ...
    CascadingFacetConfiguration configuration = getConfiguration();
  ...
  @Nullable
  public static CascadingFacet getInstance( @NotNull final Module module )
    {
    return FacetManager.getInstance( module ).getFacetByType( CascadingFacetType.ID );
    }
  ...
  public static boolean isLibraryPresent( @Nullable Module module )
    ...
    return psiFacade.findClass( "cascading.flow.Flow", CascadingSearchScope.classInModuleWithDependenciesAndLibraries( module ) ) != null;
    }
